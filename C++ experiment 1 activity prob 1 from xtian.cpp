...
int main()
{
	...
	//Prices and Tickets
	cout << "Please enter Box ticket price: " << endl;
	cin >> BoxPrice;
	cout << "Please enter Sideline ticket price: " << endl;
	cin >> SidelinePrice;
	cout << "Please enter Premium ticket price: "<< endl;
	cin >> PremiumPrice;
	cout << "Please enter General Admission Price: "<< endl;
	cin >> GeneralAdmissionPrice;
	cout << "Number of Box ticket/s sold: "<< endl;
	cin >> box;
	cout << "Number of Sideline ticket/s sold: "<< endl;
	cin >> sideline;
	cout << "Number of Premium ticket/s sold: "<< endl;
	cin >> premium;
	cout << "Number of General Admission ticket/s sold: "<< endl;
